...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // A real browser request starts with only the user id in the session.
        // Resolve that user inside the temporary auth-bootstrap scope before
        // Laravel's auth middleware queries the tenant-scoped User model.
