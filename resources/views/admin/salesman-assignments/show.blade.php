<x-layouts.app>
    <div class="mb-6 flex flex-wrap items-start justify-between gap-4">
        ...
        @if(auth()->user()->hasPermission('sales-team:manage'))<a href="{{ route('admin.salesman-assignments.edit', $assignment) }}" class="rounded-xl bg-indigo-500 px-4 py-2.5 font-semibold">Edit</a>@endif
    </div>
