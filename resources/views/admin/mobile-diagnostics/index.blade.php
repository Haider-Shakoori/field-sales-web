    ...
    <div class="overflow-hidden rounded-2xl border border-white/10 bg-slate-900">
        <div class="overflow-x-auto">
            <table class="min-w-full text-left text-sm">
                ...
                @forelse($diagnostics as $diagnostic)
                    <tr class="align-top">
                        ...
                        <td class="px-5 py-4">
                            ...
                            @if($diagnostic->code)
                                <div class="mt-1 text-xs text-slate-500">{{ $diagnostic->code }}</div>
                            @endif
                        </td>
                        <td class="px-5 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-5 py-12 text-center text-slate-400">No mobile diagnostics have been reported.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
