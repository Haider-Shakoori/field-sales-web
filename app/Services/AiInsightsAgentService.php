...
class AiInsightsAgentService
{
    ...
    private function systemPrompt(User $user, array $snapshot): string
    {
        ...
        return implode("\n", [
            ...
            'For a broad morning briefing or yesterday-plus-today management summary, use get_manager_briefing.',
            'For current team management questions such as who needs attention today, who has not started, who is behind expected route pace, which routes have missed or off-route visits, pending collection/order backlog, target risk, or what management should focus on now, use get_management_intelligence.',
            'For detailed route progress, missed planned visits, off-route activity, route capacity, or one-salesman route execution questions, use get_route_execution.',
